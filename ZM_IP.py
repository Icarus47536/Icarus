...
def login(driver):
    try:
        ...
        pass
    # 输入账号密码
    driver.find_element(By.XPATH, '//*[@id="login_phone"]').send_keys(Config.username)
    driver.find_element(By.XPATH, '//*[@id="login_password"]').send_keys(Config.password)
    # 获取滑块位置
...
def put_request(driver, batch):
    try:
        input = driver.find_element(By.XPATH,
                                    '//*[@id="api-content"]/div[1]/div/div/div[1]/div[5]/div[2]/div[1]/div/div[1]/div/input')
        input.clear()  # 清空输入框
        input.clear()  # 再清空一次
        time.sleep(0.5)
        input.send_keys(f'{batch}')  # 输入需要的ip数量
        driver.find_element(By.XPATH,
                            '//*[@id="api-content"]/div[1]/div/div/div[1]/div[8]/div[2]/div/label[2]').click()  # ip的稳定时长5-25分钟
        driver.find_element(By.XPATH,
                            '//*[@id="api-content"]/div[1]/div/div/div[1]/div[9]/div[2]/div/label[2]/span').click()  # 选择json
        driver.find_element(By.XPATH,
                            '//*[@id="api-content"]/div[1]/div/div/div[1]/div[13]/div[2]/div/label[2]').click()  # 选择城市
        driver.find_element(By.XPATH,
                            '//*[@id="api-content"]/div[1]/div/div/div[1]/div[14]/div[2]/div[2]/div/label[1]/span[1]/span').click()  # 北京
        driver.find_element(By.XPATH,
                            '//*[@id="api-content"]/div[1]/div/div/div[1]/div[14]/div[2]/div[2]/div/label[27]/span[1]/span').click()  # 陕西
        driver.find_element(By.XPATH,
                            '//*[@id="api-content"]/div[1]/div/div/div[1]/div[14]/div[2]/div[2]/div/label[18]/span[1]/span').click()  # 湖南
        time.sleep(0.5)
        driver.find_element(By.XPATH, '//*[@id="api-content"]/div[1]/div/div/div[1]/div[19]/div[2]/div').click()  # 点击生成API
    except NoSuchElementException as e:
        print(f"Error in put_request: {e}")
...
if __name__ == '__main__':
    ...
    driver.find_element(By.XPATH, '//*[@id="api-content"]/div[1]/div/div/div[1]/div[19]/div[2]/div').click()  # 点击生成API
    driver.find_element(By.XPATH,
                        '//*[@id="api-content"]/div[1]/div/div/div[1]/div[20]/div[1]/div[2]/div[2]/a[1]').click()  # 点击复制链接
    time.sleep(1)  # 等待复制
    ...
    if json_result:
        ...
        # 将ip的json形式存入文件中
        with open('WJX_Script/ip.json', 'w', encoding='utf-8') as f:
            f.write(json_result)
            print("写入完成!")